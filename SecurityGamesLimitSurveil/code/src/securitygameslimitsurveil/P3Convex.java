...
public class P3Convex {
    ...
    public static void ReadOutput() {
        ...
        String objectiveFile = "objectiveP3.txt";
        String strategyFile = "defender_stratP3.txt";
    ...
    public static void Solve() {
        GenerateGameFiles.GenerateFilesP3();

        String scriptFilename = "P3_convex.run";
        RunSolver.run(scriptFilename);
        isInfeasible = RunSolver.isInfeasible;
        ReadOutput();
